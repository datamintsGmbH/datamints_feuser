 ...
 *
 *
 *  102: class tx_datamintsfeuser_pi1 extends tslib_pibase
 *  165:     public function main($content, $conf)
 *  247:     public function doFormSubmit()
 *  460:     public function checkValid()
 *  613:     public function checkUnique()
 *  646:     public function checkRequired()
 *  710:     public function checkCaptcha($value)
 *  776:     public function cleanPasswordField(&$arrUpdate, $fieldName, $fieldConfig)
 *  798:     public function cleanCheckField(&$arrUpdate, $fieldName, $fieldConfig)
 *  833:     public function cleanMultipleSelectField(&$arrUpdate, $fieldName, $fieldConfig)
 *  869:     public function cleanGroupDatabaseField(&$arrUpdate, $fieldName, $fieldConfig)
 *  914:     public function cleanUncleanedField(&$arrUpdate, $fieldName, $fieldConfig)
 *  941:     public function saveDeleteFiles(&$arrUpdate, $fieldName, $fieldConfig)
 * 1060:     public function copyFields(&$arrUpdate)
 * 1112:     public function doUserEdit(&$arrUpdate)
 * 1159:     public function deleteUser()
 * 1175:     public function doUserRegister(&$arrUpdate)
 * 1242:     public function getRelationInserts(&$arrUpdate)
 * 1277:     public function insertRelationInserts($userId, $arrInserts = array())
 * 1314:     public function showOutputRedirect($mode, $submode = '', $params = array())
 * 1395:     public function sendActivationMail($userId = 0)
 * 1442:     public function doApprovalCheck()
 * 1528:     public function getApprovalTypes()
 * 1539:     public function setNotActivatedCookie($userId)
 * 1552:     public function getNotActivatedUserArray($arrNotActivated = array())
 * 1584:     public function sendMail($userId, $templatePart, $adminMail, $config, $extraMarkers = array(), $extraSuparts = array())
 * 1715:     public function isAdminApprovalType($approvalType)
 * 1727:     public function getTemplateSubpart($templatePart, $markerArray = array(), $config = array())
 * 1746:     public function getValuesForMail()
 * 1914:     public function getChangedForMail($arrNewData, $config)
 * 1952:     public function getPasswordForMail()
 * 1973:     public function showForm($valueCheck = array())
 * 2190:     public function mergeRelationValues($userId, $arrCurrentData)
 * 2252:     public function showInput($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '', $valueCheck = array(), $iItem = 0)
 * 2308:     public function showText($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '')
 * 2325:     public function showCheck($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '')
 * 2378:     public function showRadio($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '')
 * 2414:     public function showSelect($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '')
 * 2512:     public function showGroup($fieldName, $fieldConfig, $arrCurrentData, $disabledField = '')
 * 2631:     public function showCaptcha($fieldName, $valueCheck, $iItem)
 * 2700:     public function getFieldId()
 * 2725:     public function getFieldClasses($iItem, $fieldName, $fieldType = '', $valueCheck = array())
 * 2745:     public function getFieldName()
 * 2768:     public function getLabel($fieldName, $checkRequired = TRUE)
 * 2811:     public function getErrorType($fieldName, $valueCheck)
 * 2828:     public function getErrorClass($fieldName, $valueCheck)
 * 2846:     public function getErrorLabel($fieldName, $valueCheck)
 * 2863:     public function isRequiredField($fieldName)
 * 2878:     public function getTableLabelFieldName($table)
 * 2893:     public function getHiddenParamsArray()
 * 2910:     public function getHiddenParamsHiddenFields()
 * 2959:     public function getParamArrayFromParamNameParts($arrParamNameParts, &$arrRequest, &$arrParams)
 * 3002:     public function determineConfiguration()
 * 3048:     public function determineIrreConfiguration()
 * 3200:     public function getConfigurationByShowtype($subConfig = '')
 * 3213:     public function getJSValidationConfiguration()
 *
 *
 * TOTAL FUNCTIONS: 55
 *
